...
void save(){
    ...
    fprintf(fp,"%d %d %d %d %d %d", player.XLocation, player.YLocation, player.lives, healingRegen, turns, monsterLives);
    fclose(fp);
    turns -=1;
...
void load(){
    ...
    fscanf(fp,"%d %d %d %d %d %d", &player.XLocation, &player.YLocation, &player.lives, &healingRegen, &turns, &monsterLives);
    fclose(fp);
    turns -=1;
}